...
{
	//Text for Story
	public string text01; //Deep Dark
	public string text02; //Wagner
	public string text03; //The fairy loretta
	public string text04; //Wagner with the fairy
	public string text05; //The way out
	public string text06; //Wagners/Players Task
	public string text07; //Epilog-Text
